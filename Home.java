...
public class Home{
    ...
    public void homeView(int id) throws SQLException {
        ...
        x.setForeground(Color.decode("#37474D"));
        ...
        min.setForeground(Color.decode("#37474D"));
        ...
        students.setForeground(Color.decode("#37474A"));
        frame.add(students);
        ...
        addattendance.setForeground(Color.decode("#37474A"));
        ...
        editattendance.setForeground(Color.decode("#37474A"));
        ...
        teacher.setForeground(Color.decode("#37474A"));
        frame.add(teacher);
        ...
        admin.setForeground(Color.decode("#37474A"));
        frame.add(admin);
        ...
        classes.setForeground(Color.decode("#37474A"));
        frame.add(classes);
