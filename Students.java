...
public class Students {
    ...
    public void studentView() throws SQLException {
        ...
        x.setForeground(Color.decode("#37474A"));
        ...
        back.setForeground(Color.decode("#37474A"));
        ...
        idbox.setFont(text);
        idbox.setForeground(Color.decode("#37474A"));
        ...
        username.setForeground(Color.decode("#37474A"));
        ...
        name.setFont(text);
        name.setForeground(Color.decode("#37474A"));
        ...
        password.setForeground(Color.decode("#37474A"));
        ...
        save.setForeground(Color.decode("#37474A"));
        ...
        edit.setForeground(Color.decode("#37474A"));
        frame.add(edit);
        ...
        add.setForeground(Color.decode("#37474A"));
        frame.add(add);
        ...
        delete.setForeground(Color.decode("#37474A"));
        delete.setEnabled(false);
        frame.add(delete);
        ...
        frame.getContentPane().setBackground(Color.decode("#37474A"));
