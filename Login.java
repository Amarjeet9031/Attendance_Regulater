...
public class Login{
    ...
    public void loginView() {
        ...
        attendance.setForeground(Color.decode("#37474A"));
        ...
        management.setForeground(Color.decode("#37474A"));
        ...
        panel.setBackground(Color.decode("#DEE4E"));
        frame.add(panel);
        //---------------------------------------------------------

        //------------------------CLOSE---------------------------
        JLabel x = new JLabel("X");
        x.setForeground(Color.decode("#DEE4E"));
